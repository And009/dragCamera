...
import com.crisw.dragcamera.util.AngleUtil;
import com.crisw.dragcamera.util.CameraParamUtil;
import com.crisw.dragcamera.util.CheckPermission;
import com.crisw.dragcamera.util.FileUtil;
...
public class CameraInterface implements Camera.PreviewCallback {
    ...
    private SensorEventListener sensorEventListener = new SensorEventListener() {
        ...
        public void onSensorChanged(SensorEvent event) {
            ...
            angle = AngleUtil.INSTANCE.getSensorAngle(values[0], values[1]);
            rotationAnimation();
        }
        ...
        if (mCamera != null) {
            try {
                ...
                Camera.Size previewSize = CameraParamUtil.getInstance().getPreviewSize(mParams
                        .getSupportedPreviewSizes(), 2000, screenProp);
                Camera.Size pictureSize = CameraParamUtil.getInstance().getPictureSize(mParams
                        .getSupportedPictureSizes(), 3000, screenProp);
